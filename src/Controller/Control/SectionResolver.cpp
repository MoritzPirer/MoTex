...
std::pair<Position, Position> SectionResolver::fromDelimiter(EditorState& state, RangeSettings settings) {
...
std::pair<Position, Position> SectionResolver::fromScope(EditorState& state, ScopeSettings settings) {
    return {
