...
const std::vector<VisualSegment>& RenderInfo::getTextAreaRow(int index) const {
...
const std::vector<VisualSegment>& RenderInfo::getPanelRow(int index) const {
...
VisualSegment RenderInfo::getAsideRow(int index) const {
...
VisualSegment RenderInfo::getOverlayRow(int index) const {
